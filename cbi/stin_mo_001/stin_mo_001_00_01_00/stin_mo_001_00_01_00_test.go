...
const Example_stin_mo_001_00_01_00 = "example-document-stin_mo_001_00_01_00.xml"

func TestDocument_STIN_MO_001_00_01_00(t *testing.T) {
	d := stin_mo_001_00_01_00.Document{
	...
	err = os.WriteFile(Example_stin_mo_001_00_01_00, b, fs.ModePerm)
	require.NoError(t, err)
	defer os.Remove(Example_stin_mo_001_00_01_00)
